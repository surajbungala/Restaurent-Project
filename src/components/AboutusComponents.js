...
function About(props) {
    ...
    const leaders = props.leaders.map((leader) => {
        return (
            <RenderLeader leader =  {leader.name}/>
        );
    });
        ...
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col-12 col-md-6">
                    <h2>Our History</h2>
                    <p>Started in 2020, Ristorante con Fusion quickly established itself as a culinary icon par excellence in Hong Kong.
                    ...
                    <p>The restaurant traces its humble beginnings to <em>The Frying Pan</em>,
                       a successful chain started by our CEO, Mr. Peter Pan, that featured for the first time the world's best cuisines in a pan.</p>
                </div>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <dl className="row p-1">
                                ...
                                <dd className="col-6">&#8377; 12,12,55,375</dd>
